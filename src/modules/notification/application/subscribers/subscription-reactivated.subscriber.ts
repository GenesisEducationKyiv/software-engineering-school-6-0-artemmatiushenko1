...
export class SubscriptionReactivatedSubscriber extends IdempotentSubscriber<SubscriptionReactivatedEvent> {
  ...
  private async deliver(event: SubscriptionReactivatedEvent): Promise<void> {
