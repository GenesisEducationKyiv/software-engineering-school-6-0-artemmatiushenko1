...
> **Note**: [swagger.yaml](./swagger.yaml) file contains API documentation. You can view it using [Swagger Editor](https://editor.swagger.io/). **Changing the contracts is not allowed.**
